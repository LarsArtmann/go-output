// Package version holds the single source of truth for the example CLIs'
// version string. Every build self-identifies with the git commit it was
// built from, plus a "-dirty" suffix when the working tree had uncommitted
// changes:
//
...
//
//	-X github.com/larsartmann/go-output/pkg/version.injected=<shortRev>
//
...
// Version is the CLI version: the ldflags-injected string when present,
