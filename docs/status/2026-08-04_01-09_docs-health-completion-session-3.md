...
| 6 | **Fixed FEATURES.md hardcoded count** — replaced with recompute command reference         | `grep -c '                                                                                |
...
| 4 | **Verified count is ALREADY wrong**                            | I wrote "189 FULLY_FUNCTIONAL" as the count. But the grep counts TABLE ROWS with `                                                                                                                                                                                                                                                                                                                                                                  |
