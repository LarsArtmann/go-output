...
require (
	...
	github.com/larsartmann/go-output/d2 v0.30.3
	github.com/larsartmann/go-output/delimited v0.30.3
	github.com/larsartmann/go-output/graph v0.30.3
	github.com/larsartmann/go-output/markup v0.30.3
	github.com/larsartmann/go-output/nom v0.30.3
	github.com/larsartmann/go-output/plantuml v0.30.3
	github.com/larsartmann/go-output/serialization v0.30.3
	github.com/larsartmann/go-output/table v0.30.3
	github.com/larsartmann/go-output/testhelpers v0.30.3
	github.com/larsartmann/go-output/tui v0.30.3
)
...
require (
	...
	github.com/larsartmann/go-output/escape v0.30.3 // indirect
