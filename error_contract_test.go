...
func TestTypedErrors_AsType_ThroughWrapping(t *testing.T) {
	...
	t.Run("InvalidLineStyleError from ParseLineStyle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("UnsupportedFormatError from RenderTable", func(t *testing.T) {
		t.Parallel()
...
func TestTypedErrors_ErrorMessages_IncludeAllowedValues(t *testing.T) {
	...
	tests := []struct {
		...
		{"InvalidShapeError", &InvalidShapeError{Value: "x", Allowed: AllShapes}, "(allowed: table, tree, graph)"},
		{"InvalidColorModeError", &InvalidColorModeError{Value: "x", Allowed: AllColorModes}, "(allowed: auto, always, never)"},
		{"InvalidFormatError", &InvalidFormatError{Value: "x", Allowed: AllFormats}, "(allowed: "},
		{"InvalidLineStyleError", &InvalidLineStyleError{Value: "x", Allowed: AllLineStyles}, "(allowed: solid, dashed, dotted)"},
		{"InvalidNodeShapeError", &InvalidNodeShapeError{Value: "x", Allowed: AllNodeShapes}, "(allowed: box, ellipse, diamond, circle, cylinder, hexagon, parallelogram)"},
	}
